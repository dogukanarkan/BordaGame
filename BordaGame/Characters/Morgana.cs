...
{
    class Morgana : ICharacter
    {
        public Morgana()
        {
            firstSkillName = "Morgana1";
            secondSkillName = "Morgana2";
            HealthPoint = 100;
            ManaPoint = 100;
            AttackPoint = 10;
            DefensePoint = 10;
        ...
        {
            Console.WriteLine("Basic attack from Morgana.");
            c.HealthPoint = c.HealthPoint + c.DefensePoint - AttackPoint;
        }
        public void FirstSkill(ICharacter c)
        {
            Console.WriteLine($"First skill from Morgana and this skill name is {firstSkillName}");
            c.HealthPoint = c.HealthPoint + c.DefensePoint - 20;
        }

        public void SecondSkill(ICharacter c)
        {
            Console.WriteLine($"Second skill from Morgana and this skill name is {secondSkillName}");
