...
{
    class Ahri : ICharacter
    {
        public Ahri()
        {
            firstSkillName = "Ahri1";
            secondSkillName = "Ahri2";
            HealthPoint = 100;
            ManaPoint = 100;
            AttackPoint = 10;
            DefensePoint = 10;
        ...
        {
            Console.WriteLine("Basic attack from Ahri.");
            c.HealthPoint = c.HealthPoint + c.DefensePoint - AttackPoint;
        }
        public void FirstSkill(ICharacter c)
        {
            Console.WriteLine($"First skill from Ahri and this skill name is {firstSkillName}");
            c.HealthPoint = c.HealthPoint + c.DefensePoint - 20;
        }

        public void SecondSkill(ICharacter c)
        {
            Console.WriteLine($"Second skill from Ahri and this skill name is {secondSkillName}");
