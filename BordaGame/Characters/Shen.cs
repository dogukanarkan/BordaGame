...
{
    class Shen : ICharacter
    {
        public Shen()
        {
            firstSkillName = "Shen1";
            secondSkillName = "Shen2";
            HealthPoint = 100;
            ManaPoint = 100;
            AttackPoint = 10;
            DefensePoint = 10;
        ...
        {
            Console.WriteLine("Basic attack from Shen.");
            c.HealthPoint = c.HealthPoint + c.DefensePoint - AttackPoint;
        }
        public void FirstSkill(ICharacter c)
        {
            Console.WriteLine($"First skill from Shen and this skill name is {firstSkillName}");
            c.HealthPoint = c.HealthPoint + c.DefensePoint - 20;
        }

        public void SecondSkill(ICharacter c)
        {
            Console.WriteLine($"Second skill from Shen and this skill name is {secondSkillName}");
